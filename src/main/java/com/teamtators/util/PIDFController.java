// 99% of this was copy/pasted from the wpilib source code btw
...
public class PIDFController implements Sendable, AutoCloseable {
     ...
     *
     * <p>Set the proportional, integral, and differential coefficients, and feedforward value.
     *
     * @param kp The proportional coefficient.
     * @param ki The integral coefficient.
     * @param kd The derivative coefficient.
    ...
    /**
     * Sets the Feedforward term of the PIDF controller gain.
     *
    ...
    public double calculate(double measurement) {
        ...
        return m_kp * m_positionError + m_ki * m_totalError + m_kd * m_velocityError + m_kf;
    }
